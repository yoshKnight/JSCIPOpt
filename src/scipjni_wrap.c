...
SWIGEXPORT jint JNICALL Java_jscip_SCIPJNIJNI_SCIPgetNNodes(JNIEnv *jenv, jclass jcls, jlong jarg1) {
  jint jresult = 0 ;
  SCIP *arg1 = (SCIP *) 0 ;
  int result;
  ...
  (void)jcls;
  arg1 = *(SCIP **)&jarg1; 
  result = (int)SCIPgetNNodes(arg1);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_jscip_SCIPJNIJNI_SCIPgetNCuts(JNIEnv *jenv, jclass jcls, jlong jarg1) {
  jint jresult = 0 ;
  SCIP *arg1 = (SCIP *) 0 ;
  int result;
